...
import { Loader2, UserPlus, Mail, Trash2, Shield, Wrench, Coffee } from 'lucide-react'
...
export default function EquipoClient({ miembros: miembrosIniciales, rolActual, tallerId }: Props) {
      ...
      <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-100">
          <h2 className="text-sm font-semibold text-gray-900">
            Miembros del taller ({miembros.length})
          </h2>
        </div>
