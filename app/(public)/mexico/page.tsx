  ...
  return (
    ...
    <section className="lh">
      ...
      <div className="lh-inner">
        <div className="lh-left">
          ...
          <h1 className="lh1">
            Tu taller en México<br/>
            merece ser <span className="ltw">{WORDS[tIdx].slice(0,tChar)}<span className="lc">|</span></span>
          </h1>
          <p className="lh-sub">TallerOS digitaliza tu taller mecánico en México con aprobaciones por WhatsApp, portal del cliente en tiempo real y reseñas automáticas en Google. Usado por talleres en CDMX, Monterrey, Guadalajara y más.</p>
        ...
        <div className="lh-right">
          <div className="lmock">
            <img src="/hero-dashboard.png" alt="TallerOS Dashboard México" className="lmock-s" />
    ...
    <section className="lcta">
      ...
      <div className="lcta-i">
        ...
        <h2 className="lcta-h2">Tu taller en México merece crecer.</h2>
