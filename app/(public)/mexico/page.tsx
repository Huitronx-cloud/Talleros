...
// Schema.org structured data for México
const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'SoftwareApplication',
  name: 'TallerOS',
  applicationCategory: 'BusinessApplication',
  description: 'Software para talleres mecánicos en México con aprobaciones por WhatsApp, portal del cliente en tiempo real y reseñas automáticas en Google.',
...
export const metadata: Metadata = {
  ...
  description: 'TallerOS es el software #1 para talleres mecánicos en México. Aprobaciones por WhatsApp, portal del cliente, reseñas automáticas en Google y recordatorios de mantenimiento. Precios en MXN. 14 días gratis.',
  keywords: [
    ...
    'gestión órdenes trabajo mecánico México',
    'WhatsApp aprobación reparaciones México',
  ],
  alternates: {
    canonical: '/mexico',
  },
  openGraph: {
    title: 'Software para Talleres Mecánicos en México — TallerOS',
    description: 'El software que usan los mejores talleres mecánicos en México. Aprobaciones por WhatsApp, portal del cliente y reseñas automáticas en Google. 14 días gratis.',
    url: 'https://www.tallerosapp.com/mexico',
    locale: 'es_MX',
  },
}
...
const FEATURES = [
  ...
  { icon: Shield,        titulo: 'Garantía digital',          desc: 'Garantías digitales firmadas en cada entrega. Diferénciate de cualquier competidor.' },
    ...
    <div style={{fontFamily:'system-ui,sans-serif',color:'#0f172a',background:'#fff'}}>
      ...
      <section style={{background:'#f8fafc',padding:'60px 24px'}}>
        <div style={{maxWidth:900,margin:'0 auto',display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(200px,1fr))',gap:20}}>
          {[
            { n:'63%', t:'de clientes mexicanos desconfía de talleres mecánicos', c:'#ef4444' },
            { n:'97%', t:'lee reseñas de Google antes de elegir un taller en México', c:'#f59e0b' },
            { n:'+40%', t:'más ingresos con recordatorios automáticos de mantenimiento', c:'#2563eb' },
            { n:'14', t:'días gratis para probarlo en tu taller sin compromisos', c:'#22c55e' },
          ].map((s,i) => (
            <div key={i} style={{background:'#fff',border:'1px solid #e2e8f0',borderRadius:16,padding:'28px 20px',textAlign:'center',boxShadow:'0 2px 8px rgba(0,0,0,0.05)'}}>
              <div style={{fontSize:48,fontWeight:900,color:s.c,letterSpacing:-2,lineHeight:1,marginBottom:10}}>{s.n}</div>
              <p style={{fontSize:13,color:'#64748b',lineHeight:1.6}}>{s.t}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section style={{background:'#1d4ed8',padding:'72px 24px',textAlign:'center'}}>
        <div style={{maxWidth:600,margin:'0 auto'}}>
          <h2 style={{fontSize:'clamp(26px,4vw,44px)',fontWeight:900,color:'#fff',letterSpacing:-1.5,marginBottom:16}}>
            Tu taller en México merece crecer.
          </h2>
          <p style={{fontSize:17,color:'#bfdbfe',lineHeight:1.7,marginBottom:32}}>
            14 días gratis, sin tarjeta de crédito. Cancela cuando quieras.
          </p>
          <Link href="/registro" style={{display:'inline-flex',alignItems:'center',gap:8,background:'#fff',color:'#1d4ed8',padding:'14px 32px',borderRadius:12,textDecoration:'none',fontSize:16,fontWeight:800,boxShadow:'0 8px 32px rgba(0,0,0,0.2)'}}>
