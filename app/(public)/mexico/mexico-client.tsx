...
const TESTIMONIALES = [
  ...
  { texto: 'Las aprobaciones por WhatsApp cambiaron todo. Antes perdíamos trabajos porque el cliente no contestaba. Ahora aprueba en segundos.',                   nombre: 'Carolina Méndez', rol: 'AutoFix, Guadalajara MX',      img: '/testi-2-camila.png',  estrellas: 5 },
  { texto: 'Los recordatorios automáticos nos trajeron clientes que no veíamos en años. Es como tener un vendedor trabajando 24/7 sin pagarle extra.',             nombre: 'Miguel Hernández', rol: 'Mecánica Hernández, CDMX MX', img: '/testi-3-miguel.png',  estrellas: 5 },
]
...
const STATS_DATA = [
  { valor: '63%',  texto: 'de clientes desconfía de talleres mecánicos en México', icon: AlertTriangle, color: '#ef4444' },
  { valor: '97%',  texto: 'lee reseñas antes de elegir un taller',                  icon: Star,          color: '#f59e0b' },
  { valor: '#1',   texto: 'queja en México: cobros no autorizados',                 icon: MessageCircle, color: '#a855f7' },
  { valor: '+40%', texto: 'más ingresos con recordatorios automáticos',             icon: TrendingUp,    color: '#06b6d4' },
]
...
export default function MexicoClient() {
  ...
  return (
      ...
      <div className="lh-inner">
        <div className="lh-left">
          <div className="ley">
            ...
            Software de gestión para talleres mecánicos en México
          </div>
          <h1 className="lh1">
            Se acabaron las llamadas de<br/>
            <span className="ltw" style={{fontStyle:'italic'}}>&ldquo;¿Cómo va mi carro?&rdquo;</span>
          </h1>
          <p className="lh-sub">Tus clientes ven el estado en vivo. Aprueban reparaciones por WhatsApp. TallerOS se encarga del resto — en México.</p>
        ...
        <div className="lh-right">
          <div className="lmock">
            <Image src="/Gemini_Generated_Image_t2xuqlt2xuqlt2xu.png" alt="TallerOS Dashboard México" width={895} height={1200} priority sizes="(max-width: 900px) 92vw, 44vw" className="lmock-s" />
    ...
    <section className="ls lprob">
      <div className="li">
        <div className="lsl">El problema real en México</div>
        <h2 className="lsh2">Los números que tu competencia ignora</h2>
        <p className="lssub">Mientras la mayoría de talleres en México opera igual que hace 20 años, los que usan TallerOS ya van adelante.</p>
        <div className="lstg">
          {STATS_DATA.map((s,i) => (
    ...
    <section id="caracteristicas" className="ls lfeat-s">
      <div className="li">
        <div className="lsl">Por que nos eligen en México</div>
        <h2 className="lsh2">6 herramientas que transforman tu taller en 30 dias</h2>
        <p className="lssub">Cada función resuelve un problema real que cuesta clientes y dinero todos los días en los talleres de México.</p>
        <div className="lfg">
    ...
    <section id="modulos" className="ls lmod-s">
      <div className="li">
        ...
        <h2 className="lsh2">Todo lo que tu taller en México necesita</h2>
        ...
        <div className="lmw">
          <div className="lmimgs">
            <Image src="/mod-img1.png" alt="Recepcion taller con TallerOS México" width={1200} height={896} sizes="(max-width: 768px) 92vw, 40vw" className="lmimg"/>
            <Image src="/mod-img2.png" alt="Mecánicos usando TallerOS en México" width={1200} height={896} sizes="(max-width: 768px) 92vw, 40vw" className="lmimg lmimg2"/>
          </div>
    ...
    <section className="lgal">
      <div className="lgal-i">
        <div className="lgal-t">
          <div className="lsl">Talleres reales en México</div>
          <h2 className="lgal-h2">Talleres mexicanos que ya dieron el salto digital</h2>
          <p className="lgal-sub">Mecánicos y dueños de taller en CDMX, Monterrey, Guadalajara, Puebla y toda la República Mexicana confían en TallerOS.</p>
        ...
        <div className="lgal-grid">
          {[
            ...
            { img:'/taller-ramirez.png',  nombre:'Mecánica Automotriz Ramírez',  ciudad:'Monterrey, MX'        },
            { img:'/taller-vargas.png',   nombre:'Centro Automotriz Vargas',     ciudad:'Puebla, MX'           },
          ].map((t,i) => (
    ...
    <section id="testimoniales" className="ls ltesti-s">
      <div className="li">
        <div className="lsl">Lo que dicen nuestros clientes en México</div>
        <h2 className="lsh2">Talleres mexicanos que ya dieron el salto</h2>
        <div className="ltg">
    ...
    <section id="precios" className="ls lprice-s">
      <div className="li">
        ...
        <div className="lproof">
          ...
          <p className="lproof-t"><strong>{stats.total > 0 ? `+${stats.total}` : '+50'} talleres</strong> en México ya digitalizaron su operación</p>
        </div>
      </div>
    </section>
      ...
      <div className="li">
        <div className="llm-w">
          <div className="llm-txt">
            <div className="lsl" style={{textAlign:'left'}}>Guía gratuita para talleres en México</div>
            <h2 className="llm-h2">5 errores que le cuestan clientes a tu taller mecánico en México</h2>
            <p className="llm-sub">Descubre los errores más comunes que cometen los talleres en México — y cómo eliminarlos desde hoy.</p>
    ...
    <section className="lcta">
      ...
      <div className="lcta-i">
        <div className="lsl" style={{color:'#93c5fd'}}>Empieza hoy en México</div>
        <h2 className="lcta-h2">Deja de perder clientes por no tener sistema.</h2>
        <p className="lcta-sub">Únete a los talleres mexicanos que ya digitalizaron su operación.<br/>14 días gratis, sin tarjeta de crédito.</p>
    ...
    <footer className="lfoot">
      <div className="lfoot-i">
        ...
        <p className="lfoot-c">2026 TallerOS. Gestión inteligente para talleres mecánicos en México.</p>
