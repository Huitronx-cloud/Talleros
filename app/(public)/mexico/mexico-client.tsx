    ...
    <section className="lh">
      ...
      <div className="lh-inner">
        ...
        <div className="lh-right">
          <div className="lmock">
            <img src="/Gemini_Generated_Image_t2xuqlt2xuqlt2xu.png" alt="TallerOS Dashboard México" className="lmock-s" />
      ...
      <div className="li">
        ...
        <div className="lmw">
          <div className="lmimgs">
            <img src="/mod-img1.png" alt="Recepcion taller con TallerOS México" className="lmimg"/>
            <img src="/mod-img2.png" alt="Mecánicos usando TallerOS en México" className="lmimg lmimg2"/>
          </div>
