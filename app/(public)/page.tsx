    ...
    <footer className="lfoot">
      <div className="lfoot-i">
        ...
        <div className="lfoot-lnks">
          {[{l:'Blog',h:'/blog'},{l:'Privacidad',h:'/privacidad'},{l:'Terminos',h:'/terminos'},{l:'💬 Soporte WhatsApp',h:'https://wa.me/17242625304'},{l:'✉ hola@tallerosapp.com',h:'mailto:hola@tallerosapp.com'}].map(x => (<a key={x.l} href={x.h}>{x.l}</a>))}
        </div>
      </div>
    </footer>
