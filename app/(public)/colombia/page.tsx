...
export const metadata: Metadata = {
  ...
  description: 'TallerOS es el software #1 para talleres mecánicos en Colombia. Aprobaciones por WhatsApp, portal del cliente, reseñas automáticas en Google y recordatorios de mantenimiento. 14 días gratis.',
  keywords: [
  ...
  alternates: { canonical: 'https://www.tallerosapp.com/colombia' },
  openGraph: {
    title: 'Software para Talleres Mecánicos en Colombia — TallerOS',
      ...
      <section style={{padding:'80px 24px'}}>
        <div style={{maxWidth:1100,margin:'0 auto'}}>
          <div style={{textAlign:'center',marginBottom:56}}>
            ...
            <p style={{fontSize:16,color:'#64748b',maxWidth:520,margin:'0 auto',lineHeight:1.7}}>Cada función resuelve un problema real que le cuesta clientes y dinero a los talleres en Colombia todos los días.</p>
          </div>
