...
export const metadata: Metadata = {
  ...
  description: 'Digitaliza tu taller mecánico en Colombia con aprobaciones por WhatsApp, portal del cliente en tiempo real y reseñas automáticas en Google. Plan gratis para siempre, sin tarjeta.',
  alternates: {
    canonical: '/colombia',
    languages: {
  ...
  twitter: {
    ...
    title: 'Software para talleres mecánicos en Colombia — TallerOS',
    description: 'Digitaliza tu taller mecánico en Colombia con TallerOS. Plan gratis para siempre.',
  },
}
