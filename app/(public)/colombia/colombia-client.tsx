      ...
      <div className="li">
        ...
        <div className="lmw">
          <div className="lmimgs">
            <img src="/mod-img1.png" alt="Recepcion taller con TallerOS Colombia" className="lmimg"/>
            <img src="/mod-img2.png" alt="Mecánicos usando TallerOS en Colombia" className="lmimg lmimg2"/>
          </div>
