...
const TESTIMONIALES = [
  { texto: 'Desde que usamos TallerOS los clientes ya no llaman a preguntar cómo va su carro. El portal en tiempo real nos ahorró horas de atención telefónica.', nombre: 'Roberto Cárdenas', rol: 'Taller Cárdenas, Bogotá CO',  img: '/testi-1-roberto.png', estrellas: 5 },
  ...
  { texto: 'Los recordatorios automáticos nos trajeron clientes que no veíamos en años. Es como tener un vendedor trabajando 24/7 sin pagarle extra.',             nombre: 'Miguel Vargas',   rol: 'Mecánica Vargas, Cali CO',     img: '/testi-3-miguel.png',  estrellas: 5 },
]
...
const STATS_DATA = [
  { valor: '63%',  texto: 'de clientes desconfía de talleres mecánicos en Colombia', icon: AlertTriangle, color: '#ef4444' },
  { valor: '97%',  texto: 'lee reseñas antes de elegir un taller',                  icon: Star,          color: '#f59e0b' },
  { valor: '#1',   texto: 'queja en Colombia: cobros no autorizados',                 icon: MessageCircle, color: '#a855f7' },
...
export default function ColombiaClient() {
  ...
  return (
      ...
      <div className="lh-inner">
        <div className="lh-left">
          <div className="ley">
            ...
            Software de gestión para talleres mecánicos en Colombia
          </div>
          <h1 className="lh1">
            Se acabaron las llamadas de<br/>
            <span className="ltw" style={{fontStyle:'italic'}}>&ldquo;¿Cómo va mi carro?&rdquo;</span>
          </h1>
          <p className="lh-sub">Tus clientes ven el estado en vivo. Aprueban reparaciones por WhatsApp. TallerOS se encarga del resto — en Colombia.</p>
    ...
    <section className="ls lprob">
      <div className="li">
        <div className="lsl">El problema real en Colombia</div>
        <h2 className="lsh2">Los números que tu competencia ignora</h2>
        <p className="lssub">Mientras la mayoría de talleres en Colombia opera igual que hace 20 años, los que usan TallerOS ya van adelante.</p>
        <div className="lstg">
          {STATS_DATA.map((s,i) => (
    ...
    <section id="modulos" className="ls lmod-s">
      <div className="li">
        ...
        <h2 className="lsh2">Todo lo que tu taller en Colombia necesita</h2>
        ...
        <div className="lmw">
          <div className="lmimgs">
            <Image src="/mod-img1.png" alt="Recepcion taller con TallerOS Colombia" width={1200} height={896} sizes="(max-width: 768px) 92vw, 40vw" className="lmimg"/>
            <Image src="/mod-img2.png" alt="Mecánicos usando TallerOS en Colombia" width={1200} height={896} sizes="(max-width: 768px) 92vw, 40vw" className="lmimg lmimg2"/>
          </div>
    ...
    <section id="testimoniales" className="ls ltesti-s">
      <div className="li">
        <div className="lsl">Lo que dicen nuestros clientes en Colombia</div>
        <h2 className="lsh2">Talleres colombianos que ya dieron el salto</h2>
        <div className="ltg">
    ...
    <section id="precios" className="ls lprice-s">
      <div className="li">
        ...
        <div className="lproof">
          ...
          <p className="lproof-t"><strong>{stats.total > 0 ? `+${stats.total}` : '+50'} talleres</strong> en Colombia ya digitalizaron su operación</p>
        </div>
      </div>
    </section>
      ...
      <div className="li">
        <div className="llm-w">
          <div className="llm-txt">
            <div className="lsl" style={{textAlign:'left'}}>Guía gratuita para talleres en Colombia</div>
            <h2 className="llm-h2">5 errores que le cuestan clientes a tu taller mecánico en Colombia</h2>
            <p className="llm-sub">Descubre los errores más comunes que cometen los talleres en Colombia — y cómo eliminarlos desde hoy.</p>
    ...
    <section className="lcta">
      ...
      <div className="lcta-i">
        <div className="lsl" style={{color:'#93c5fd'}}>Empieza hoy en Colombia</div>
        <h2 className="lcta-h2">Deja de perder clientes por no tener sistema.</h2>
        <p className="lcta-sub">Únete a los talleres colombianos que ya digitalizaron su operación.<br/>14 días gratis, sin tarjeta de crédito.</p>
    ...
    <footer className="lfoot">
      <div className="lfoot-i">
        ...
        <p className="lfoot-c">2026 TallerOS. Gestión inteligente para talleres mecánicos en Colombia.</p>
