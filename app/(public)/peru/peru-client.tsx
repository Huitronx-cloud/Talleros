...
const STATS_DATA = [
  { valor: '63%',  texto: 'de clientes desconfía de talleres mecánicos en Perú', icon: AlertTriangle, color: '#ef4444' },
  { valor: '97%',  texto: 'lee reseñas antes de elegir un taller',                  icon: Star,          color: '#f59e0b' },
  { valor: '#1',   texto: 'queja en Perú: cobros no autorizados',                 icon: MessageCircle, color: '#a855f7' },
...
export default function PeruClient() {
  ...
  return (
    ...
    <section className="ls lprob">
      <div className="li">
        <div className="lsl">El problema real en Perú</div>
        <h2 className="lsh2">Los números que tu competencia ignora</h2>
        <p className="lssub">Mientras la mayoría de talleres en Perú opera igual que hace 20 años, los que usan TallerOS ya van adelante.</p>
        <div className="lstg">
          {STATS_DATA.map((s,i) => (
    ...
    <section id="caracteristicas" className="ls lfeat-s">
      <div className="li">
        <div className="lsl">Por qué nos eligen en Perú</div>
        <h2 className="lsh2">6 herramientas que transforman tu taller en 30 días</h2>
        <p className="lssub">Cada función resuelve un problema real que cuesta clientes y dinero todos los días en los talleres de Perú.</p>
        <div className="lfg">
    ...
    <section id="testimoniales" className="ls ltesti-s">
      <div className="li">
        <div className="lsl">Lo que dicen nuestros clientes en Perú</div>
        <h2 className="lsh2">Talleres peruanos que ya dieron el salto</h2>
        <div className="ltg">
      ...
      <div className="li">
        <div className="llm-w">
          <div className="llm-txt">
            <div className="lsl" style={{textAlign:'left'}}>Guía gratuita para talleres en Perú</div>
            <h2 className="llm-h2">5 errores que le cuestan clientes a tu taller mecánico en Perú</h2>
            <p className="llm-sub">Descubre los errores más comunes que cometen los talleres en Perú — y cómo eliminarlos desde hoy.</p>
    ...
    <section className="lcta">
      ...
      <div className="lcta-i">
        ...
        <p className="lcta-sub">Únete a los talleres peruanos que ya digitalizaron su operación.<br/>Gratis para siempre, sin tarjeta de crédito.</p>
