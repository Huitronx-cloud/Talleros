...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'gestión órdenes trabajo mecánico Perú',
  ],
  alternates: { canonical: '/peru' },
  openGraph: {
    title: 'Software para Talleres Mecánicos en Perú — TallerOS',
    description: 'El software que usan los mejores talleres mecánicos en Perú. Aprobaciones por WhatsApp, portal del cliente y reseñas automáticas en Google. 14 días gratis.',
