...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'programa para taller mecánico Perú',
    'sistema gestión taller automotriz Perú',
    'app taller mecánico Perú',
    'software taller Lima',
    'software taller Arequipa',
    'software taller Trujillo',
  ],
  alternates: { canonical: 'https://www.tallerosapp.com/peru' },
  openGraph: {
    title: 'Software para Talleres Mecánicos en Perú — TallerOS',
...
const FEATURES = [
  ...
  { icon: Shield,        titulo: 'Garantía digital',          desc: 'Garantías digitales firmadas en cada entrega. Diferénciate de cualquier competidor en Perú.' },
  ...
  { icon: Star,          titulo: 'Reseñas en Google',         desc: 'Solicita reseñas automáticamente al entregar. El 97% de peruanos las lee antes de elegir taller.' },
]
    ...
    <div style={{fontFamily:'system-ui,sans-serif',color:'#0f172a',background:'#fff'}}>
      ...
      <section style={{background:'linear-gradient(135deg,#1e3a5f 0%,#1d4ed8 100%)',padding:'80px 24px',textAlign:'center'}}>
        <div style={{maxWidth:720,margin:'0 auto'}}>
          ...
          <h1 style={{fontSize:'clamp(28px,5vw,52px)',fontWeight:900,color:'#fff',lineHeight:1.05,letterSpacing:-1.5,marginBottom:20}}>
            El software que los mejores<br/>talleres mecánicos de Perú<br/>ya están usando
          </h1>
          <p style={{fontSize:18,color:'#bfdbfe',lineHeight:1.7,marginBottom:32,maxWidth:560,margin:'0 auto 32px'}}>
            Digitaliza tu taller con aprobaciones por WhatsApp, portal del cliente en tiempo real y reseñas automáticas en Google. Desde Lima hasta Arequipa.
          </p>
          ...
          <div style={{display:'flex',justifyContent:'center',gap:24,marginTop:20,flexWrap:'wrap'}}>
            {['Sin tarjeta de crédito','14 días gratis','Soporte en español','Soporte en español'].map(t => (
      ...
      <section style={{padding:'80px 24px'}}>
        <div style={{maxWidth:1100,margin:'0 auto'}}>
          <div style={{textAlign:'center',marginBottom:56}}>
            <div style={{fontSize:11,fontWeight:800,color:'#2563eb',letterSpacing:2.5,textTransform:'uppercase',marginBottom:12}}>Por qué nos eligen en Perú</div>
            ...
            <p style={{fontSize:16,color:'#64748b',maxWidth:520,margin:'0 auto',lineHeight:1.7}}>Cada función resuelve un problema real que le cuesta clientes y dinero a los talleres en Perú todos los días.</p>
          </div>
      ...
      <section style={{background:'#1d4ed8',padding:'72px 24px',textAlign:'center'}}>
        <div style={{maxWidth:600,margin:'0 auto'}}>
          <h2 style={{fontSize:'clamp(26px,4vw,44px)',fontWeight:900,color:'#fff',letterSpacing:-1.5,marginBottom:16}}>Tu taller en Perú merece crecer.</h2>
