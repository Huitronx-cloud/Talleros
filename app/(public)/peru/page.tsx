...
export const metadata: Metadata = {
  ...
  description: 'Digitaliza tu taller mecánico en Perú con aprobaciones por WhatsApp, portal del cliente en tiempo real y reseñas automáticas en Google. Plan gratis para siempre, sin tarjeta.',
  alternates: {
    canonical: '/peru',
    languages: {
  ...
  twitter: {
    ...
    title: 'Software para talleres mecánicos en Perú — TallerOS',
    description: 'Digitaliza tu taller mecánico en Perú con TallerOS. Plan gratis para siempre.',
  },
}
