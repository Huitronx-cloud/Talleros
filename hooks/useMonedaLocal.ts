...
const TASAS_APROXIMADAS: Record<string, { moneda: string; simbolo: string; tasa: number }> = {
  ...
  MX: { moneda: 'MXN', simbolo: '$',   tasa: 16.97 },
  CO: { moneda: 'COP', simbolo: '$',   tasa: 3156  },
  AR: { moneda: 'ARS', simbolo: '$',   tasa: 1512.28 },
  CL: { moneda: 'CLP', simbolo: '$',   tasa: 926   },
  PE: { moneda: 'PEN', simbolo: 'S/',  tasa: 3.35  },
  EC: { moneda: 'USD', simbolo: '$',   tasa: 1     },
  GT: { moneda: 'GTQ', simbolo: 'Q',   tasa: 7.63   },
  CR: { moneda: 'CRC', simbolo: '₡',  tasa: 450.35   },
  DO: { moneda: 'DOP', simbolo: 'RD$', tasa: 58.38    },
  VE: { moneda: 'USD', simbolo: '$',   tasa: 1     },
  BO: { moneda: 'BOB', simbolo: 'Bs.', tasa: 11.83   },
  PY: { moneda: 'PYG', simbolo: '₲',  tasa: 5928  },
  UY: { moneda: 'UYU', simbolo: '$',   tasa: 40.25    },
  HN: { moneda: 'HNL', simbolo: 'L',   tasa: 26.85    },
  SV: { moneda: 'USD', simbolo: '$',   tasa: 1     },
  PA: { moneda: 'USD', simbolo: '$',   tasa: 1     },
  NI: { moneda: 'NIO', simbolo: 'C$',  tasa: 36.8  },
  BR: { moneda: 'BRL', simbolo: 'R$',  tasa: 5.16  },
